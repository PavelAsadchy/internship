...
import { IQueryParams } from 'apps/booking/src/app/shared/models/query-params.model';
...
import { SELECT_QUERY_PARAMS } from 'apps/booking/src/app/shared/stores/booking-store/booking.selector';
import {
