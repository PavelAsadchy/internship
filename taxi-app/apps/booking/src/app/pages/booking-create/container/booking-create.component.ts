...
import { DEFAULT_BOOKING_PARAMS } from 'apps/booking/src/app/shared/consts/booking-options.consts';
import { IBooking } from 'apps/booking/src/app/shared/models/booking.model';
import { CREATE_BOOKING_ACTION } from 'apps/booking/src/app/shared/stores/booking-store/booking.actions';
