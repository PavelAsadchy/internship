...
import {
  ...
  PickUp,
  Vehicle,
} from 'apps/booking/src/app/shared/models/booking-options.model';
import { CreateBookingCalculationService } from 'apps/booking/src/app/shared/services/create-booking-calculation.service';
